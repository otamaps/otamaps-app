...
topics: [architecture, onboarding, privacy, permissions, location, authentication, supabase, social, wilma]
sources:
  - id: user-preferences
    type: file
